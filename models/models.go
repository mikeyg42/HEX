...
type MatchmakingEvt struct {
	pubsub.Event
	PlayerA_ID string `json:"initialplayerID"`
	PlayerB_ID string `json:"swapplayerID"`
}
...
type GameStartEvent struct {
	...
	PlayerA_ID string
	PlayerB_ID string
	TimerEvt   *TimerON_StartTurnAnnounceEvt
}
...
type TimerON_StartTurnAnnounceEvt struct {
	...
	ThisTurnEndTime time.Time
	MoveNumber      int
} // starttime will be included in the timestamp generated by the pubsub.Event method
