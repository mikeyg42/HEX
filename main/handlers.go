	...
	case *hex.DeclaringMoveCmd:
		...
		cacheErr := con.Persister.Cache.Once(&cache.Item{
			...
			Do: func(*cache.Item) (interface{}, error) {
				...
				return storage.retrieveMoveList(ctx, cmd.GameID, &lockedGame)
			},
		})
...
func fetchMoveList(ctx context.Context, GameID string, lockedGame *hex.LockedGame, con *hex.Container) (map[int]string, bool) {
